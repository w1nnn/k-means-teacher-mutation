...
if (isset($_POST['submit'])) {
    $npsn = $_POST['username'];
    $sqlCek = mysqli_query($con, "SELECT * FROM tb_kebutuhan WHERE npsn='$npsn'");
    ...
    if ($jml > 0) {
        ...
        <script>
         ...
         window.location.replace('./sekolah/');
        </script>";
    } else {
        echo "
            <script type='text/javascript'>
            alert('NPSN tidak ditemukan');
            </script>";
    }
}
?>
...
<body class="overflow-hidden">
    ...
    <!-- End dark mode -->
    <div class="row match-height d-flex justify-content-center" style="margin: 90px auto;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="" class="form form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                    <!-- <div class="col-md-4">
                                        <label for="email-horizontal-icon">Username</label>
                                    </div> -->
                                    <div class="col-md-12">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" autocomplete="off" name="username" class="form-control" placeholder="NPSN" id="email-horizontal-icon">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button id="btn-guru" name="submit" type="submit" class="btn btn-info" style="margin: 30px auto; width: 100%;">Login</button>
                                    </div>
                                    <p>Tidak Punya akun? <a href="registrasi-sekolah.php">Daftar</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
