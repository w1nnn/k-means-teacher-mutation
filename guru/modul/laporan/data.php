                    ...
                    <div class="card-body">
                        <form action="?page=laporan&act=tahun" method="POST">
                            <div class="input-group mb-3" style="width: 300px;">
                                <input type="date" class="form-control flatpickr-no-config" placeholder="Pilih Periode Tahun" aria-label="Example text with button addon" aria-describedby="button-addon1" name="tahun">
                                <button name="btn" class="btn btn-info btn-sm" type="submit" id="button-addon1">Cetak</button>
                            </div>
                        </form>
