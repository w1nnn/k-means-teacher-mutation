					...
					<div class="card-body">
						<form method="POST" action="" class="form form-horizontal">
							<div class="form-body">
								<div class="row">
									<div class="col-md-4">
										<label for="email-horizontal-icon">NIP/NUPTK</label>
									</div>
									<div class="col-md-8">
										<div class="form-group has-icon-left">
											<div class="position-relative">
												<input type="text" autocomplete="off" name="nip" class="form-control" placeholder="NIP/NUPTK" id="email-horizontal-icon">
									...
									<div class="col-12 d-flex justify-content-end">
										<button name="submit" type="submit" class="btn btn-info me-1 mb-5">Daftar</button>
									</div>
								</div>
							</div>
						</form>
