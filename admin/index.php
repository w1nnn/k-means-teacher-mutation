							...
							<div class="form-body">
								<div class="row">
									...
									<div class="col-md-8">
										<div class="form-group has-icon-left">
											<div class="position-relative">
												<input type="text" autocomplete="off" name="username" class="form-control" placeholder="Username" id="email-horizontal-icon">
									...
									<div class="col-md-8">
										<div class="form-group has-icon-left">
											<div class="position-relative">
												<input type="password" autocomplete="off" name="password" class="form-control" placeholder="Password" id="password-horizontal-icon">
												<div class="form-control-icon">
									...
									<div class="col-12 d-flex justify-content-end">
										<button name="submit" type="submit" class="btn btn-info me-1 mb-5">Login</button>
									</div>
								</div>
							</div>
						</form>
